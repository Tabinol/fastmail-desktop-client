...
import SpellCheckerMenu from '../../src/main/SpellCheckerMenu';
...
describe('getLanguageSubmenu', () => {
  const languageSubmenu = spellCheckerMenu.menuItemConstructorOptions()[1]
...
function findMenuItemByLanguage(
  languageSubmenu: MenuItemConstructorOptions[],
  lang: string
